          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            >
              ...
              <div className="text-left">
                <div style={{ fontSize: 'clamp(10px, 2vw, 12px)', lineHeight: 'clamp(12px, 2.5vw, 14px)' }}>Get it on</div>
            ...
            >
              ...
              <div className="text-left">
                <div style={{ fontSize: 'clamp(10px, 2vw, 12px)', lineHeight: 'clamp(12px, 2.5vw, 14px)' }}>Download on the</div>
