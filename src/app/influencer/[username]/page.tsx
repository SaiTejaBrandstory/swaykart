  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-4 sm:pb-8">
        ...
        <div className="bg-white dark:bg-white rounded-2xl shadow-sm border border-gray-200 dark:border-gray-200 p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-900 mb-6 sm:mb-8" style={{ fontFamily: 'Inter' }}>Profile Analytics</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8">
            ...
            <div className="text-center p-4 sm:p-6 rounded-lg" style={{ 
              ...
              <div className="text-base sm:text-lg mb-2 text-gray-500 dark:text-gray-500" style={{ 
                fontFamily: 'Inter'
              }}>Followers</div>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 lg:gap-6">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-500 dark:text-gray-500" style={{ 
                fontFamily: 'Inter'
              }}>Posts</div>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white dark:bg-white rounded-xl shadow-sm border border-gray-200 dark:border-gray-200 p-6">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-900 mb-4">Basic Information</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    <span className="text-gray-600 dark:text-gray-600">Categories</span>
                    <span className="font-medium text-gray-900 dark:text-gray-900">{influencer.categories_combined || 'N/A'}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    <span className="text-gray-600 dark:text-gray-600">Locations</span>
                    <span className="font-medium text-gray-900 dark:text-gray-900">{influencer.locations_combined || 'N/A'}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    <span className="text-gray-600 dark:text-gray-600">Verified</span>
                    <span className="font-medium text-gray-900 dark:text-gray-900">{influencer.verified ? 'Yes' : 'No'}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    <span className="text-gray-600 dark:text-gray-600">Influencer Rank</span>
                    <span className="font-medium text-gray-900 dark:text-gray-900">#{influencer.influencer_rank || 'N/A'}</span>
                  </div>
                </div>
              </div>
              ...
              {/* Content Performance */}
              <div className="bg-white dark:bg-white rounded-xl shadow-sm border border-gray-200 dark:border-gray-200 p-6">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-900 mb-4">Content Performance</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    <span className="text-gray-600 dark:text-gray-600">Days Between Posts</span>
                    <span className="font-medium text-gray-900 dark:text-gray-900">{influencer.average_days_between_posts || 'N/A'}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    <span className="text-gray-600 dark:text-gray-600">Hashtag Diversity</span>
                    <span className="font-medium text-gray-900 dark:text-gray-900">{influencer.hashtag_diversity || 'N/A'}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    <span className="text-gray-600 dark:text-gray-600">Total Hashtags</span>
                    <span className="font-medium text-gray-900 dark:text-gray-900">{influencer.total_unique_hashtags || 'N/A'}</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    <span className="text-gray-600 dark:text-gray-600">Avg Hashtags/Post</span>
                    <span className="font-medium text-gray-900 dark:text-gray-900">{influencer.avg_hashtags_per_post || 'N/A'}</span>
                  </div>
                </div>
              </div>
            </div>
